const angularVersion = "10.1.4";
const typeScriptVersion = "3.9.7";
const rxJsVersion = "6.6.3";
...
System.config({
  ...
  map: {
    ...
    "@angular/platform-browser":
      `npm:@angular/platform-browser@${angularVersion}/bundles/platform-browser.umd.js`,
    "@angular/platform-browser-dynamic":
      `npm:@angular/platform-browser-dynamic@${angularVersion}/bundles/platform-browser-dynamic.umd.js`,
    rxjs: `npm:rxjs@${rxJsVersion}`,
    "rxjs-compat": `npm:rxjs-compat@${rxJsVersion}`,
